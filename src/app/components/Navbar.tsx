...
export default function AppNavbar() {
  ...
  // Navigation links data - easy to add more links
  const navLinks = [
    { href: "/products", label: "Products", icon: FileBox, color: "sky" },
    { href: "/about-us", label: "About Us", icon: Users, color: "emerald" },
    { href: "/faq", label: "FAQ", icon: HelpCircle, color: "violet" },
    { href: "/contact-us", label: "Contact Us", icon: Mail, color: "indigo" },
  ];
            ...
            {user ? (
              ...
              <div className="pt-4 mt-2 border-t border-slate-200">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 px-5 py-3.5 bg-gradient-to-r from-violet-500 to-violet-600 hover:from-violet-600 hover:to-violet-700 text-white font-semibold rounded-xl shadow-lg shadow-violet-500/25 transition-all duration-200"
                >
